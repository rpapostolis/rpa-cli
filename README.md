...
- For customers and partners that have access to the very limited Automation Starter Kit private preview program, and planning using the **AutoCoE** target option, make sure you have solution version **0_0_1_4** or higher installed.
